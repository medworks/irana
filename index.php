		...
		<div class="main png_bg">
			...
			<!-- True containers (keep the content inside containers!) -->
				<div class="container_alpha slider">
					<div id="slider" class="nivoSlider" style="display: block; position: relative; height: 350px; background: url(http://etherna.html.themeforest.designsentry.com/images/slides/slide5.jpg) no-repeat;">
