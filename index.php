				...
				<div class="container_gamma slogan" style="background-color:#DE5328">
					<div class="search">
						<form id="frmtel" name="frmtel" action="" method="POST">
							<input type="text" id="tel" onpaste="return false" name="tel" style="color:#000;width:220px;height:25px;font-size:25px;line-height:32px;margin-right:5px"  class="ltr" placeholder="5138555560"  maxlength="10"  onkeypress="return isNumber(event);">
