            ...
            <section class="container_6 clearfix">
                <div class="grid_6">
					<form class="setting" action="" method="post">
					    <p><span style="display:block;margin-bottom:5px;">نام کاربری اس ام اس</span><input type="text" name="smsuser" class="ltr" placeholder="نام کاربری" value="{$SmsUserName}"  /></p>
					    <p><span style="display:block;margin-bottom:5px;">رمز عبور اس ام اس</span><input type="password" name="smspassword" class="ltr" placeholder="رمز عبور" value="{$SmsPassWord}" /></p>
						<p><span style="display:block;margin-bottom:5px;">شماره خط اسم ام اس</span><input type="text" name="smslinenumber" class="ltr" placeholder="شماره خط" value="{$SmsLineNumber}"  /></p>
